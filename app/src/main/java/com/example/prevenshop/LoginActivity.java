    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(password)){
                    mPassword.setError("Inserire Password.");
                    return;
                }
        ...
        forgotTextLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                passwordResetDialog.setMessage("Inserisci Email per ricevere il link di reset.");
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(LoginActivity.this, "Errore ! Link di reset non inviato." + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
